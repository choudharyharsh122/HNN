...
def get_args(lenient=False):
    ...
    parser.add_argument('--hidden_dim', default=100, type=int, help='dimension of each hidden layer of the MLP')
    ...
    parser.add_argument('--data_samples', default=16384, type=int, help='number of samples in datasets')
